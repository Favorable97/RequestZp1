    ...
    public partial class Registration : UserControl {
        ...
        private void AddUsers() {
            ...
            try {
                ...
                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["con"].ConnectionString)) {
                    con.Open();
                    using (SqlCommand com = new SqlCommand("INSERT INTO Users(Surname, Name, FatherName, Department, Rights, Password) VALUES (@Surname, @Name, @FatherName, @Department, @Rights, @Password)", con)) {
        ...
        private void RecordListOperationAddUser() {
            try {
                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["con"].ConnectionString)) {
                    con.Open();
                    using (SqlCommand com = new SqlCommand("INSERT INTO ListOperation(IP, DateTime, ID, Operation) VALUES (@IP, @DateTimeLogIn, @ID, @Operation)", con)) {
                        con.Open();
